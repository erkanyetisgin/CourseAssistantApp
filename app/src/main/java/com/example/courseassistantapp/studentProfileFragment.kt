...
class studentProfileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val nameTextView = view.findViewById<TextView>(R.id.student_profile_name)
        val emailTextView = view.findViewById<TextView>(R.id.student_profile_email)
        val idTextView = view.findViewById<TextView>(R.id.student_profile_id)
        val dobTextView = view.findViewById<TextView>(R.id.student_profile_dob)
        val educationLevelTextView = view.findViewById<TextView>(R.id.student_education_level)
        val phoneTextView = view.findViewById<TextView>(R.id.student_profile_phone_number)
        ...
        val phoneButton = view.findViewById<ImageButton>(R.id.student_phonecall)
        val emailButton = view.findViewById<ImageButton>(R.id.student_email)
        val addInstagram = view.findViewById<Button>(R.id.add_instagram)
        val instagramTextView = view.findViewById<TextView>(R.id.student_profile_instagram)
        val whatsappTextView = view.findViewById<TextView>(R.id.student_profile_whatsapp)
        val profile_picture = view.findViewById<ImageView>(R.id.student_profile_image)
        ...
        userRef.get()
            .addOnSuccessListener { document ->
                if (document != null && document.exists()) {
                    ...
                    idTextView.text = user?.get("studentId").toString()
